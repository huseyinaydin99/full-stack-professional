...
const LinkItems = [
    {name: 'Ana Sayfa', route: '/dashboard', icon: FiHome},
    {name: 'Müşteri Kayıtları', route: '/dashboard/customers',  icon: FiUsers},
    {name: 'Ayarlar', route: '/dashboard/settings', icon: FiSettings},
];
